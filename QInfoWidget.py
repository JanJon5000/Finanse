...
class QInfoWidget(QWidget):
    ...
    def populateLayout(self):
        ...
        self.dataWidgets = {
            'infoTexts':[QLabel("srednie zyski/straty:"), QLabel("największy/najmniejszy zysk/strata w jednej transakcji"), QLabel('mediana zysków/strat'), QLabel('udzial kategorii w zyskach/stratach'), QLabel('udzial osób w zyskach/stratach')],
